...
This guide outlines the recommended workflow for contributing to the ABE-RabbitMQ project.
...
- Browse existing [GitHub Issues](https://github.com/Chisanan232/abe-rabbitmq/issues) to find something to work on
...
First, fork the ABE-RabbitMQ project to your own GitHub account:

1. Go to the [ABE-RabbitMQ repository](https://github.com/Chisanan232/abe-rabbitmq)
...
git remote add upstream https://github.com/Chisanan232/abe-rabbitmq.git
...
- Ask questions in the [GitHub Discussions](https://github.com/Chisanan232/abe-rabbitmq/discussions)
