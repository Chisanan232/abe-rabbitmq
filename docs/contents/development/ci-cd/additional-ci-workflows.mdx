...
This document covers the specialized CI workflows that support specific aspects of the ABE-RabbitMQ project beyond the main continuous integration and release processes.
...
The [`docs-build-check.yaml`](https://github.com/Chisanan232/abe-rabbitmq/blob/master/.github/workflows/docs-build-check.yaml) workflow validates that documentation builds successfully whenever documentation-related files are modified.
...
[![Docs-only auto-approve & automerge](https://github.com/Chisanan232/abe-rabbitmq/actions/workflows/docs-automerge.yml/badge.svg)](https://github.com/Chisanan232/abe-rabbitmq/actions/workflows/docs-automerge.yml)
